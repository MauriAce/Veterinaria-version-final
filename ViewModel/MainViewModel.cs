...
namespace Veterinaria.ViewModel
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public ICommand ShowTurnoViewCommand { get; }
        public MainViewModel()
        {
            ...
            ShowTurnoViewCommand = new ViewModelCommand(ExecuteShowTurnoViewCommand);
            //Default View
        ...
        private void ExecuteShowTurnoViewCommand(object obj)
        {
            CurrentChildView = new TurnoViewModel();
            Caption = "Nuevo Turno";
            Icon = IconChar.CalendarDays;
        }
